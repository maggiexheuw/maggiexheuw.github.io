...
<p style="font-size: 1.1rem; margin-bottom: 2rem;">
  This page collects the PDF lecture notes from Prof. Fengcheng Wu's series of talks at the 2026 Greater Bay Area Quantum Science Summer School.
  Topics include topological moiré bands, integer and fractional quantum anomalous Hall effects, collective excitations, and non-Abelian fractional quantum states.
  All files are stored in the <code>PPTX/</code> folder. Click to download or view online.
</p>
...
<div style="display: flex; flex-direction: column; gap: 1.5rem;">
  ...
  <!-- Lecture 2.2 -->
  <div style="border-left: 5px solid #3b8bba; padding-left: 1.2rem; background: #f8f9fa; border-radius: 0 8px 8px 0; padding: 1rem 1.2rem;">
    <h3 style="margin: 0 0 0.3rem 0; color: #2c3e50;">
  ...
  <!-- Lecture 3.1 -->
  <div style="border-left: 5px solid #e67e22; padding-left: 1.2rem; background: #f8f9fa; border-radius: 0 8px 8px 0; padding: 1rem 1.2rem;">
    <h3 style="margin: 0 0 0.3rem 0; color: #2c3e50;">
      📘 Lecture 3.1 – Integer Chern Insulators &amp; Competing States in tMoTe₂
    </h3>
    <p style="margin: 0.2rem 0; color: #555;">
  ...
  <!-- Lecture 3.2 -->
  <div style="border-left: 5px solid #8e44ad; padding-left: 1.2rem; background: #f8f9fa; border-radius: 0 8px 8px 0; padding: 1rem 1.2rem;">
    <h3 style="margin: 0 0 0.3rem 0; color: #2c3e50;">
      📘 Lecture 3.2 – Collective Excitations
    </h3>
    <p style="margin: 0.2rem 0; color: #555;">
  ...
  <!-- Lecture 4 -->
  <div style="border-left: 5px solid #c0392b; padding-left: 1.2rem; background: #f8f9fa; border-radius: 0 8px 8px 0; padding: 1rem 1.2rem;">
    <h3 style="margin: 0 0 0.3rem 0; color: #2c3e50;">
      📘 Lecture 4 – Abelian &amp; Non‑Abelian Fractional Chern Insulators in tMoTe₂
    </h3>
    <p style="margin: 0.2rem 0; color: #555;">
